...
* Rename every file that has `Carbon.Accounts` in its name, replacing `Carbon.Accounts` with the module name.
* Replaces `Carbon.Accounts` in every file with the module name.
